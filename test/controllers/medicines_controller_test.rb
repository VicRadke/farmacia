...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicine" do
    assert_difference('Medicine.count') do
      post medicines_url, params: { medicine: { name: @medicine.name, patent: @medicine.patent, price: @medicine.price, quantity: @medicine.quantity } }
    end
  ...
  test "should update medicine" do
    patch medicine_url(@medicine), params: { medicine: { name: @medicine.name, patent: @medicine.patent, price: @medicine.price, quantity: @medicine.quantity } }
